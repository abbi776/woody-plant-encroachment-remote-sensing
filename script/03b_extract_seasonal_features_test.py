#!/usr/bin/env python3
"""
Extract seasonal per-polygon features for the TEST set.
Same logic as the TRAIN script but with test defaults.
"""
...
def parse_args():
    ...
    ap.add_argument("--labels", default="data/processed/testing_labels.shp")
    ...
    ap.add_argument("--out", default="docs/tables/seasonal_features_test.xlsx")
