#!/usr/bin/env python3
"""
Apply a trained RF model (.pkl) to a multi-band feature raster and save a classified map.
- Assumes features in raster match training features order.
- Writes single-band int16 raster with nodata=-1.
"""
...
def main():
    ...
    ap.add_argument("--model", required=True, help="RF .pkl from training")
